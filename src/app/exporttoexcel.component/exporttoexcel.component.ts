...
//import exec from 'script-loader!../../node_modules/xlsx/dist/xlsx.full.min.js';
  ...
  sheet_from_array_of_arrays(data) {
    ...
    for (var R = 0; R != data.length; ++R) {      
      for (var C = 0; C != data[R].length; ++C) {
        ...
        //cell.s.cellStyles = {"font" : {"bold" : true, "sz" : 13, "alignment" : { "horizontal" : "center", "vertical" : "center"}}};          
